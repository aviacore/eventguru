...
export default class Organizer extends Component {
    ...
    submitNewActivity() {
        console.log('New Activity: ' + this.state.activityName + ', ' + this.state.activityLimit + ', ' + this.state.activityTokens);
    ...
    return (
        <div className="wrapper" style={style}>
                ...
                <div className="modal modal-add-custom-activity">
                    ...
                    <div className="modal-window">
                        ...
                        <div className="form-block acivity">
                            <div className="label"><span className="icon"><img src={icon1}></img></span> Activity</div>
                            <input
                                type="text"
                        ...
                        <div className="form-block limit">
                            <div className="label"><span className="icon"><img src={icon2}></img></span> Limit</div>
                            <input
                                type="text"
                                
                                placeholder="limit"
                                onChange={this.changeActivityLimit}
                            ></input>
                        </div>
                        <div className="form-block tokens">
                            <div className="label"><span className="icon"><img src={icon3}></img></span> Tokens</div>
                            <input
                                type="text"
                                
                                placeholder="tokens"
                                onChange={this.changeActivityTokens}
                            ></input>
                        </div>
                        <button className="button button-submit-activity" onClick={this.submitNewActivity}>Add</button>
                    </div>
                </div>
            ...
            <div className="background-layer b-l-4" style={{backgroundImage: 'url(' + backWave4 + ')'}}>
